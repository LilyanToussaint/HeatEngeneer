"""Registry of available pressure-loss correlations."""
...
def _registry_key(name: str, func: CorrelationCallable) -> str:
    """Return the canonical registry key for a pressure-loss correlation."""
...
LOSS_PRESSURE_CORRELATIONS, _EXPORTED_FUNCS = _discover_correlations()
globals().update(_EXPORTED_FUNCS)

__all__ = ["LOSS_PRESSURE_CORRELATIONS", *sorted(_EXPORTED_FUNCS)]
