...
def hx_compact_performance(
    ...
    G = mass_flow / geometry["flow_area"]
    Re = G * geometry["hydraulic_diameter"] / fluid["mu"]
    if Re <= 0:
    ...
    delta_p = fanning_f_to_dp(f, G, geometry["length"], geometry["hydraulic_diameter"], fluid["rho"])
